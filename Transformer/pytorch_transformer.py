...
"""## utils for loading corpus and preprocessing"""
...
ut_en = utils(data_EN, language="english")
sent_idx_en, v2i_en = ut_en.get_idx_sentence()

ut_zh = utils(data_ZH, language="chinese")
...
if __name__ == '__main__':
    ...
    n_vocab= len(v2i_en) # encoder and decoder both need one vocab
    # build model
    m= Transformer(num_encoder_layers= N_LAYER,dim_model= MODEL_DIM, num_heads= N_HEAD, n_vocab=n_vocab, device=device)
    # start training
